# Dictionary for smj — nob

This repository contains source files for a dictionary from Lule Saami to Norwegian Bokmål. The content is licensed under the  license.
